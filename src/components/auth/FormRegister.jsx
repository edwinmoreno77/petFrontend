...
export const FormRegister = () => {
  ...
  const handlerCreateUser = (formState) => {
    ...
    //TODO:Send the user to the backend
  };

  return (
    <form className="flex flex-col items-center justify-center bg-slate-100  text-slate-600 lg:-me-4 rounded-e-2xl z-10 lg:w-full">
      <h1 className="text-center font-bold p-2">Crear cuenta</h1>
      <div className=" bg-white w-80 md:w-6/12 lg:min-w-1/4 shadow-lg rounded-2xl mb-3">
