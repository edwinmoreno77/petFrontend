...
export const Profile = () => {
  ...
  return (
    <main className="container-fluid bg-slate-100 flex flex-col items-center  min-h-screen p-5 transition-all duration-200 ease-in-out">
          ...
          {user.pets?.length < 5 ? (
            user.pets?.map((pet) => (
              ...
              >
                ...
                <div className="bg-white w-12 h-12 md:w-24 md:h-24 lg:w-24 lg:h-24 rounded-xl">
                  <img
      ...
      <section className="flex flex-col justify-center items-center shadow-xl p-3 transition-all duration-200 ease-in-out cursor-pointer text-center w-full max-w-3xl  rounded-xl bg-black text-white mb-16 min-h-96">
        {selectedPet ? (
