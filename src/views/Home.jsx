...
export function Home() {
  ...
  return (
    <main className="container-fluid z-0 bg-image-motivo bg-black flex flex-col items-center min-h-screen p-5">
      <div className="flex flex-row justify-start my-8 z-10 border-slate-800 shadow-slate-600 shadow-md p-3 hover:scale-105 duration-200 ease-in-out cursor-pointer text-center w-full max-w-4xl xl:max-w-5xl rounded-xl bg-black text-white h-48">
        <div className="flex justify-center h-16 w-16 md:w-24 md:h-24 ms-14 mt-7">
          <img
      ...
      <div className="flex flex-col justify-start items-start text-center w-full max-w-4xl xl:max-w-5xl rounded-xl bg-black text-white h-96 mb-10">
        ...
        {paginatedEvents.length === 0 ? (
          ...
          paginatedEvents.map((event) => (
            <div
              key={event.id}
              className="flex justify-start z-10 border-slate-800 p-2 my-2 text-center text-white font-bold text-xs lg:text-sm hover:scale-105 duration-200 ease-in-out hover:brightness-75 cursor-pointer w-full max-w-4xl xl:max-w-5xl rounded-xl bg-primary-green"
            >
              <div className="relative w-10 h-10 mr-4">
                <img
                  ...
                  alt="calendar"
                />
                <span className="absolute top-0 left-0 right-0 bottom-0 mt-4 text-center text-md font-extrabold text-gray-600">
